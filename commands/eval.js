...
module.exports.run = async (bot, message, args) => {
    ...
    if(message.author.id !== '394638597439094795' && '394638597439094795') return message.channel.send("Only the owner can use this command!");
    function clean(text) {
  ...
  console.log(`\n${message.author.username}#${message.author.discriminator} Used .Eval Command On ${message.guild.name}`)
    ...
    if (message.author.id !== '394638597439094795' && '394638597439094795') {
